...
`;
export const DEL_NTC = gql`
  mutation delNotice($ver: String!, $param: NoticeInput) {
    delNotice(ver: $ver, param: $param) {
      rsltCd
      errCd
      rsltCont
...
`;
export const ADD_NTC = gql`
  mutation saveNotice($ver: String!, $param: NoticeInput) {
    saveNotice(ver: $ver, param: $param) {
      rsltCd
      errCd
      rsltCont
    }
